...
function Configurator(conf) {
  ...
  // entry
  params.ENTRY_DIR = conf.ENTRY_DIR || 'src';
  ...
  params.ENTRY_FILES_EXT.filter(function (v) {
  ...
  // output
  params.OUTPUT_DIR = conf.OUTPUT_DIR || 'build';
  params.OUTPUT_FILES = conf.OUTPUT_FILES || '[name]/bundle.js';
